...
export default createStore({
  state: {
      products: [
            {id: "1", title: "Генератор бензиновый xiaomi Днепр", name: "Генератор бензиновый xiaomi 5квт модель", description: "Генератор бензиновый xiaomi 5квт модель", price: 100, imgMain: "/src/assets/1.jpg", brand: "Xiaomi", category: "generatory", categoryFilter: "Генераторы", subcategoryFilter: "Бензиновые", compare: false, wishlist: false, inCart: false},
